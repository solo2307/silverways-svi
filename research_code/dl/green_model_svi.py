...
class SegModelPSPNet:
    ...
    def _load_model(self):
        ...
        net_decoder = builder.build_decoder(
            arch=self.decoder_name, weights=str(self.decoder_file),
            fc_dim=self.fc_dim, num_class=self.num_class, use_softmax=True
        )
    ...
    def predict(self, test_image_path: str):
        ...
        dataset_test = TestDataset([{'fpath_img': test_image_path}], DEFAULT_OPTIONS, max_sample=-1)
